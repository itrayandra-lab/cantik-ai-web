...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="/admin/articles/index.php" class="nav-item <?= strpos($_SERVER['PHP_SELF'], '/articles/') !== false && $currentPage !== 'categories' ? 'active' : '' ?>">
      <span class="nav-icon">📝</span> Artikel
    </a>
    <a href="/admin/articles/create.php" class="nav-item <?= $currentPage === 'create' && strpos($_SERVER['PHP_SELF'], '/articles/') !== false ? 'active' : '' ?>">
      <span class="nav-icon">✏️</span> Tulis Artikel
    </a>
    <a href="/admin/articles/categories.php" class="nav-item <?= $currentPage === 'categories' ? 'active' : '' ?>">
